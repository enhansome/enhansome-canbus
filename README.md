...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,384 | 🐛 4 | 📅 2026-08-07
...
* 🔝[Caring Caribou](https://github.com/CaringCaribou/caringcaribou) ⭐ 941 | 🐛 13 | 🌐 Python | 📅 2026-06-12 - A friendly car security exploration tool for the CAN bus.
...
* 🔝[carhacking](https://github.com/daedalus/carhacking) ⚠️ Archived - Car hacking scripts and docs collection.
* [parse\_can\_logs](https://github.com/v-ivanyshyn/parse_can_logs) ⭐ 96 | 🐛 3 | 🌐 Python | 📅 2024-06-28 - Parse CAN logs and visualize data streams on plot.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,466 | 🐛 142 | 🌐 Python | 📅 2026-08-10 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
* [canDrive](https://github.com/adamtheone/canDrive) ⭐ 677 | 🐛 25 | 🌐 C | 📅 2023-05-27 - Tools for hacking your car.
* [canhack](https://github.com/kentindell/canhack) ⭐ 393 | 🐛 9 | 🌐 C | 📅 2024-04-01 - A low-level CAN protocol hacking library.
* [uds-server](https://github.com/zombieCraig/uds-server) ⭐ 356 | 🐛 5 | 🌐 C | 📅 2025-10-08 - CAN UDS Simulator and Fuzzer.
...
* [CANghost](https://github.com/souravbaghz/CANghost) ⭐ 141 | 🐛 0 | 🌐 Shell | 📅 2021-09-10 - Automated Script For Hacking Into CAN Bus.
...
* [ELM327-emulator](https://github.com/Ircama/ELM327-emulator) ⭐ 668 | 🐛 17 | 🌐 Python | 📅 2026-02-22 - ELM327 Emulator for testing software interfacing OBDII via ELM327 adapter supporting multi-ECU simulation.
...
* [DDT4All](https://github.com/cedricp/ddt4all) ⭐ 1,801 | 🐛 1 | 🌐 Python | 📅 2026-07-14 - Tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
* [pyvit](https://github.com/linklayer/pyvit) ⚠️ Archived - Python Vehicle Interface Toolkit *(archived)*.
* [freediag](https://github.com/fenugrec/freediag) ⭐ 483 | 🐛 14 | 🌐 C | 📅 2024-09-09 - Free diagnostic software for OBD-II compliant motor vehicles.
* [OBDium](https://github.com/provrb/obdium) ⭐ 320 | 🐛 4 | 🌐 Rust | 📅 2026-07-21 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [uds-c](https://github.com/openxc/uds-c) ⭐ 821 | 🐛 6 | 🌐 C | 📅 2021-08-16 - Unified Diagnostics Service (UDS) and OBD-II C Library.
* [python-UDSonCAN](https://github.com/pylessard/python-udsoncan) ⭐ 718 | 🐛 9 | 🌐 Python | 📅 2026-08-09 - Python implementation of UDS ISO-14229 standard.
* [iso14229](https://github.com/driftregion/iso14229) ⭐ 352 | 🐛 7 | 🌐 C | 📅 2026-08-04 - C implementation of UDS ISO-14229 server and client for embedded systems.

### ISO-TP

*ISO 15765-2 Standard*

* [isotp-c](https://github.com/openxc/isotp-c) ⭐ 355 | 🐛 8 | 🌐 C | 📅 2021-08-16 - An implementation of the ISO-TP (ISO15765-2) CAN protocol in C.
* [python-can-IsoTP](https://github.com/pylessard/python-can-isotp) ⭐ 311 | 🐛 3 | 🌐 Python | 📅 2026-06-26 - Python implementation of the ISO-TP (ISO15765-2) CAN protocol.
...
* [Open-SAE-J1939](https://github.com/DanielMartensson/Open-SAE-J1939) ⭐ 636 | 🐛 0 | 🌐 C | 📅 2026-06-25 - SAE J1939 protocol free to use for embedded systems or PC with CAN-bus.
...
* [python-can-j1939](https://github.com/juergenH87/python-can-j1939) ⭐ 141 | 🐛 49 | 🌐 Python | 📅 2026-02-04 - Package provides SAE J1939 support for Python developers.
...
* [python-j1939](https://github.com/milhead2/python-j1939) ⭐ 40 | 🐛 10 | 🌐 Python | 📅 2023-09-15 - SAE J1939 support dependent on python-can package. Provides codec and filtering by PGN but not full SPN decoding.
...
* [BUSMASTER](https://github.com/rbei-etas/busmaster) ⭐ 1,070 | 🐛 670 | 🌐 C++ | 📅 2023-07-11 - An Open Source Software tool to simulate, analyze and test data bus systems such as CAN.
* [CANiBUS](https://github.com/Hive13/CANiBUS/) ⚠️ Archived - CAN Device Vehicle Research Server (OpenGarages.org).
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) ⭐ 75 | 🐛 5 | 🌐 C | 📅 2026-08-06 - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,901 | 🐛 62 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,901 | 🐛 62 | 🌐 C | 📅 2026-05-12.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,109 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,763 | 🐛 282 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
* [CANdevStudio from GENIVI](https://github.com/GENIVI/CANdevStudio) ⭐ 1,138 | 🐛 37 | 🌐 C++ | 📅 2025-07-21 - CAN simulation software using a drag-and-drop style GUI with interconnected functional blocks.
* [ICSim](https://github.com/zombieCraig/ICSim) ⭐ 971 | 🐛 21 | 🌐 C | 📅 2025-09-18 - Instrument Cluster Simulator for SocketCAN by OpenGarages.
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 840 | 🐛 54 | 🌐 C++ | 📅 2026-08-12 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
* [TSMaster](https://github.com/TOSUN-Shanghai/TSMaster) ⭐ 422 | 🐛 85 | 📅 2026-07-07 - Powerful open environment for automotive bus monitoring, simulation, testing, diagnostics, calibration and so on *(Closed source)*.
* [CANgaroo](https://github.com/HubertD/cangaroo) ⭐ 419 | 🐛 22 | 🌐 C++ | 📅 2023-10-27 - Qt-based CAN bus analyzer software.
* [Kayak](https://github.com/dschanoeh/Kayak) ⚠️ Archived - Java-based CAN traffic GUI analysis tool *(archived)*.
* [CANviz](https://github.com/Chanchaldhiman/CANviz) ⭐ 278 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-08 - Browser-based CAN bus analyzer with J1939 and CANopen CiA 301/402 passive decode. Installs via pip, no native app required. Works with almost any CAN harware including low cost ones.
...
* [Seeed-USB-CAN-Analyzer](https://github.com/SeeedDocument/USB-CAN-Analyzer/) ⭐ 127 | 🐛 9 | 📅 2024-06-03 - Closed source binary for noname Chinese USB-CAN adapter.
...
* [CAN-Monitor-qt](https://github.com/tixiv/CAN-Monitor-qt) ⭐ 84 | 🐛 2 | 🌐 C++ | 📅 2019-07-20 - Universal CAN bus monitoring program.
...
* [Plotter and Scanner from SmartGauges](https://github.com/smartgauges/obd2-bt-stm32/tree/master/qt) ⭐ 41 | 🐛 3 | 🌐 C | 📅 2024-04-28 - Scanning and visualizing tool for automotive systems.
...
* [canair](https://github.com/philipkocanda/canair) ⭐ 16 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - CLI/TUI for reverse engineering CAN/UDS diagnostics over-the-air using a WiCAN or a generic ELM327 dongle.
...
* 🔝[cantools](https://github.com/cantools/cantools) ⭐ 2,266 | 🐛 127 | 🌐 Python | 📅 2026-08-10 - CAN BUS tools in Python.

<!--lint disable double-link-->

* 🔝[python-can](https://github.com/hardbyte/python-can) ⭐ 1,580 | 🐛 267 | 🌐 Python | 📅 2026-07-01 - CAN package provides controller area network support for Python developers.
...
* [cannelloni](https://github.com/mguentner/cannelloni) ⭐ 468 | 🐛 13 | 🌐 C++ | 📅 2026-08-02 - SocketCAN over Ethernet tunnel.
...
* [iso15765-canbus](https://github.com/devcoons/iso15765-canbus) ⭐ 193 | 🐛 0 | 🌐 C | 📅 2026-06-22 -  Implementation of ISO15765-2 in C.
* [JavaCAN](https://github.com/pschichtel/JavaCAN) ⭐ 67 | 🐛 6 | 🌐 Java | 📅 2026-08-09 - A Java binding library for SocketCAN with support for RAW, BCM and ISO-TP sockets using epoll-based event-driven IO.
* [CanKit](https://github.com/pkuyo/CanKit) ⭐ 37 | 🐛 7 | 🌐 C# | 📅 2026-08-06 - Cross-platform C#/.NET CAN communication library with a unified API across multiple CAN adapters.
...
* 🔝[cantools by Erik Moqvist](https://github.com/eerimoq/cantools) ⭐ 2,266 | 🐛 127 | 🌐 Python | 📅 2026-08-10 - CAN tools in python for DBC, KCD, SYM, ARXML 4 and CDD file parsing.
* [canmatrix](https://github.com/ebroecker/canmatrix) ⭐ 1,086 | 🐛 20 | 🌐 Python | 📅 2026-07-29 - Converting CAN Database Formats .arxml .dbc .dbf .kcd.
...
* [dbcc](https://github.com/howerj/dbcc) ⭐ 454 | 🐛 1 | 🌐 C | 📅 2025-10-07 - DBC to C (and CSV, JSON and XML) compiler using the mpc parser combinator library.
...
* [Vector CANdb++ DBC file parser](https://github.com/kdschlosser/vector_dbc) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2023-08-13 - Modified version of the dbc file parser of eerimoq.
...
* 🔝[panda](https://github.com/commaai/panda) ⭐ 1,692 | 🐛 64 | 🌐 C | 📅 2026-08-10 - It supports 3x CAN, 2x LIN, and 1x GMLAN (and it has J2534 over USB on host side). It uses an STM32F413 (Using a panda with cabana provides the best RE and development suites for CANBUS).
* 🔝[pcan\_pro\_x](https://github.com/moonglow/pcan_pro_x) ⭐ 344 | 🐛 13 | 🌐 C | 📅 2022-03-11 - PEAK PCAN PRO/PRO FD firmware for STM32F4 based boards.
...
* [vector\_can](https://github.com/moonglow/vector_can) ⭐ 63 | 🐛 4 | 📅 2022-07-28 - Vector VN1610 protocol implementation for cheap STM32F407/405 hardware (Two CAN channel).
* [BudgetCANv2](https://github.com/ryedwards/budgetcan_fw) ⭐ 57 | 🐛 3 | 🌐 C | 📅 2026-06-13 - FW for use on STM32 microcontroller to implement FDCAN and USB using the STM32 HAL. Tested on [BudgetCANv2-HW](https://github.com/ryedwards/BUDGETCANFD_G0-Hardware) ⭐ 9 | 🐛 1 | 📅 2023-02-22.
* [CAN\_OMEGA](https://github.com/zjlywjh001/CAN_OMEGA) ⭐ 52 | 🐛 1 | 📅 2017-02-13 - Ultimate CAN Bus hardware for Car hacking based on STM32F411. Full Featured [firmware](https://github.com/zjlywjh001/CAN_Omega_Firmware) ⭐ 4 | 🐛 0 | 🌐 C | 📅 2017-02-13 & [software](https://github.com/zjlywjh001/CAN_OMEGA_Tools) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2019-04-29.
...
* [zubax\_babel](https://github.com/Zubax/zubax_babel) ⭐ 40 | 🐛 4 | 🌐 C++ | 📅 2025-08-29 - High performance CAN-USB/CAN-UART adapter + UAVCAN devboard (STM32F37x).
...
* [CAN-to-USB-lawicel-for-stm32](https://github.com/kolyandex/CAN-to-USB-lawicel-for-stm32) ⭐ 23 | 🐛 0 | 🌐 C | 📅 2019-06-18 - CAN to USB adapter using Lawicel/Canhacker protocol based on STM32F103.
...
* [CAN-RS485-adapter](https://github.com/YuriyLogvin/CAN-RS485-adapter) ⭐ 7 | 🐛 0 | 🌐 C | 📅 2023-07-03 - CAN-RS485 Adapter (STM32F103).
...
* [candleLight\_fw](https://github.com/candle-usb/candleLight_fw) ⭐ 932 | 🐛 33 | 🌐 C | 📅 2026-07-17 - Compatible firmware for candleLight, cantact, canable, CANAlyze, VulCAN.
* [pcan\_cantact](https://github.com/moonglow/pcan_cantact) ⭐ 432 | 🐛 3 | 🌐 C | 📅 2022-07-28 - XCAN firmware for CANtact ( CANable ) or any other similar boards based on STM32F042.
* [cantact-hw](https://github.com/linklayer/cantact-hw) ⭐ 403 | 🐛 6 | 🌐 KiCad | 📅 2021-11-08 - Hardware design files for the CANtact tool, use [cantact-fw](https://github.com/linklayer/cantact-fw) ⭐ 278 | 🐛 16 | 🌐 C | 📅 2023-06-30 as firmware source.
* [candleLight](https://github.com/HubertD/candleLight) ⭐ 390 | 🐛 1 | 🌐 KiCad | 📅 2022-07-28 - KiCAD project of usb-can adapter based on STM32F0.
* [CANAlyze](https://kkuchera.github.io/canalyze/) - An open source, native CAN interface for Linux that can be built entirely using open source tools, use [canalyze-fw](https://github.com/kkuchera/canalyze-fw) ⭐ 72 | 🐛 9 | 🌐 C | 📅 2023-11-14 as firmware source.
...
* 🔝[arduino-canhacker](https://github.com/autowp/arduino-canhacker) ⭐ 476 | 🐛 12 | 🌐 C++ | 📅 2024-01-19 - CanHacker (lawicel) CAN adapter on Arduino + MCP2515.
* [Arduino-canbus-monitor](https://github.com/latonita/arduino-canbus-monitor) ⭐ 335 | 🐛 4 | 🌐 C++ | 📅 2025-10-22 - Can bus monitoring tool based on arduino and can bus shield. Implements CAN ASCII/SLCAN protocol compatible with Lawicel CAN232/CANUSB.
* [W203-canbus](https://github.com/rnd-ash/W203-canbus) ⭐ 168 | 🐛 3 | 🌐 C++ | 📅 2020-08-07 - Arduino project for W211/W219 W203/W209 Mercedes (bluetooth audio control and more).
...
* [CANBus-Triple](https://github.com/CANBus-Triple/CANBus-Triple-Hardware) ⭐ 59 | 🐛 1 | 🌐 Eagle | 📅 2017-06-21 - The car hacking platform based on AVR and MCP2515 works with [this firmware](https://github.com/CANBus-Triple/CANBus-Triple) ⭐ 355 | 🐛 11 | 🌐 C | 📅 2019-11-11.
...
* [epasuino](https://github.com/srenner/epasuino) ⭐ 4 | 🐛 0 | 🌐 C++ | 📅 2019-02-19 - Arduino based Speed sensitive electric power steering for automobiles  Speed sensitive electric power steering for automobiles.
...
* [arduino-mcp2515](https://github.com/autowp/arduino-mcp2515) ⭐ 1,024 | 🐛 64 | 🌐 C++ | 📅 2026-02-27 - Arduino MCP2515 CAN interface library.
* [arduino-OBD2](https://github.com/sandeepmistry/arduino-OBD2) ⭐ 568 | 🐛 15 | 🌐 C++ | 📅 2022-12-29 - Arduino library for reading OBD-II data from your car over CAN bus.
...
* [RejsaCAN-ESP32](https://github.com/MagnusThome/RejsaCAN-ESP32) ⭐ 778 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - ESP32-S3 board with CAN interface.
* [RejsaCAN-ESP32-C6](https://github.com/MagnusThome/RejsaCAN-ESP32/tree/main/Code%20Examples/RejsaCAN%20v6.x%20-%20ESP32-C6%20-%20DUAL%20CAN%20self%20test) ⭐ 778 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - Example code that is tested and runs on the new ESP32-C6 that has TWO built in CAN controllers.
...
* [ESP32RET](https://github.com/collin80/ESP32RET) ⭐ 400 | 🐛 46 | 🌐 C++ | 📅 2026-01-15 - CAN Reverse engineering tool for ESP32 based boards (unmaintained).
* [ESP32-Arduino-CAN](https://github.com/miwagner/ESP32-Arduino-CAN) ⭐ 390 | 🐛 33 | 🌐 C | 📅 2024-07-29 - Arduino CAN-Bus library for ESP32.
* [esp32\_obd2](https://github.com/MagnusThome/esp32_obd2) ⭐ 70 | 🐛 0 | 🌐 C++ | 📅 2023-12-23 - Simplified OBD2 layer to run on top of the esp32\_can library that supports the newer ESP32-S3 (Arduino library).
...
* [CTU-CAN-FD](https://github.com/Logic-Design-Services/CTU-CAN-FD) ⭐ 68 | 🐛 13 | 🌐 VHDL | 📅 2026-07-20 - CAN FD IP Core, ISO 11898-1:2015 compliant (VHDL).
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,384 | 🐛 4 | 📅 2026-08-07 root-repo for lastest updates.
2. The another awesome list :arrow\_forward: [CAN ID collections](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 974 | 🐛 0 | 📅 2026-08-12 :arrow\_backward: also might be useful.

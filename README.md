...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
...
* [GVRET](https://github.com/collin80/GVRET) ⭐ 114 | 🐛 10 | 🌐 C++ | 📅 2018-10-16 - Generalized Electric Vehicle Reverse Engineering Tool (Arduino FW).

<!--lint enable double-link-->

* [Scapy](https://github.com/secdev/scapy) ⭐ 12,565 | 🐛 136 | 🌐 Python | 📅 2026-09-23 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
...
* [DDT4All](https://github.com/cedricp/ddt4all) ⭐ 1,861 | 🐛 2 | 🌐 Python | 📅 2026-09-22 - Tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
...
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) ⭐ 79 | 🐛 6 | 🌐 C | 📅 2026-09-24 - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,920 | 🐛 61 | 🌐 C | 📅 2026-09-20 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,920 | 🐛 61 | 🌐 C | 📅 2026-09-20.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,204 | 🐛 101 | 🌐 C++ | 📅 2026-09-23 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,847 | 🐛 287 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 873 | 🐛 61 | 🌐 C++ | 📅 2026-09-24 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
...
* [bootCAN](https://github.com/friessssss/bootCAN) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 - Allows monitoring, tracing, and plotting of messages, as well as .SYM decoding and message transmitting.
...
* [JavaCAN](https://github.com/pschichtel/JavaCAN) ⭐ 68 | 🐛 7 | 🌐 Java | 📅 2026-09-24 - A Java binding library for SocketCAN with support for RAW, BCM and ISO-TP sockets using epoll-based event-driven IO.
...
* 🔝[pcan\_pro\_x](https://github.com/moonglow/pcan_pro_x) ⭐ 352 | 🐛 13 | 🌐 C | 📅 2022-03-11 - PEAK PCAN PRO/PRO FD firmware for STM32F4 based boards.
...
* [hadoucan-fw on STM32H750](https://github.com/suburbanembedded/hadoucan-fw) ⭐ 27 | 🐛 14 | 🌐 C | 📅 2026-09-23 - Firmware for SM-1301 USB-CAN FD adapter based on.
...
* 🔝[STM32duino\_CAN\_Library](https://github.com/adamczykpiotr/STM32duino_CAN_Library) ⭐ 11 | 🐛 0 | 🌐 C++ | 📅 2021-06-07 - CanBus library for STM32F103 running on STM32duino.
...
* [CANBus-Triple](https://github.com/CANBus-Triple/CANBus-Triple-Hardware) ⭐ 59 | 🐛 1 | 🌐 Eagle | 📅 2017-06-21 - The car hacking platform based on AVR and MCP2515 works with [this firmware](https://github.com/CANBus-Triple/CANBus-Triple) ⭐ 357 | 🐛 11 | 🌐 C | 📅 2019-11-11.
...
* [arduino-mcp2515](https://github.com/autowp/arduino-mcp2515) ⭐ 1,029 | 🐛 65 | 🌐 C++ | 📅 2026-02-27 - Arduino MCP2515 CAN interface library.
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07 root-repo for lastest updates.

...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
...
* [GVRET](https://github.com/collin80/GVRET) ⭐ 113 | 🐛 10 | 🌐 C++ | 📅 2018-10-16 - Generalized Electric Vehicle Reverse Engineering Tool (Arduino FW).

<!--lint enable double-link-->

* [Scapy](https://github.com/secdev/scapy) ⭐ 12,557 | 🐛 140 | 🌐 Python | 📅 2026-09-20 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
...
* [DDT4All](https://github.com/cedricp/ddt4all) ⭐ 1,854 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
...
* [OBDium](https://github.com/provrb/obdium) ⭐ 385 | 🐛 4 | 🌐 Rust | 📅 2026-09-10 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [python-UDSonCAN](https://github.com/pylessard/python-udsoncan) ⭐ 730 | 🐛 9 | 🌐 Python | 📅 2026-08-09 - Python implementation of UDS ISO-14229 standard.
* [iso14229](https://github.com/driftregion/iso14229) ⭐ 361 | 🐛 3 | 🌐 C | 📅 2026-09-20 - C implementation of UDS ISO-14229 server and client for embedded systems.
...
* [Open-SAE-J1939](https://github.com/DanielMartensson/Open-SAE-J1939) ⭐ 651 | 🐛 1 | 🌐 C | 📅 2026-09-11 - SAE J1939 protocol free to use for embedded systems or PC with CAN-bus.
...
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) ⭐ 77 | 🐛 5 | 🌐 C | 📅 2026-09-16 - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,916 | 🐛 61 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,916 | 🐛 61 | 🌐 C | 📅 2026-05-12.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,192 | 🐛 98 | 🌐 C++ | 📅 2026-09-20 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,843 | 🐛 285 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 870 | 🐛 59 | 🌐 C++ | 📅 2026-09-18 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
* [TSMaster](https://github.com/TOSUN-Shanghai/TSMaster) ⭐ 431 | 🐛 80 | 📅 2026-07-07 - Powerful open environment for automotive bus monitoring, simulation, testing, diagnostics, calibration and so on *(Closed source)*.
...
* [CAN++](https://github.com/TDahlmann/canpp) ⭐ 93 | 🐛 1 | 🌐 C | 📅 2026-09-18 - Windows program for receiving and transmitting CAN bus messages. After import of CAN data base files (`*.dbc` or `*.kcd`) CAN signals are shown in symbolic form. In addition they can be shown as graphics (wave forms).
...
* 🔝[cantools](https://github.com/cantools/cantools) ⭐ 2,287 | 🐛 129 | 🌐 Python | 📅 2026-09-16 - CAN BUS tools in Python.

<!--lint disable double-link-->

* 🔝[python-can](https://github.com/hardbyte/python-can) ⭐ 1,598 | 🐛 279 | 🌐 Python | 📅 2026-07-01 - CAN package provides controller area network support for Python developers.
...
* [iso15765-canbus](https://github.com/devcoons/iso15765-canbus) ⭐ 199 | 🐛 0 | 🌐 C | 📅 2026-06-22 -  Implementation of ISO15765-2 in C.
...
* 🔝[cantools by Erik Moqvist](https://github.com/eerimoq/cantools) ⭐ 2,287 | 🐛 129 | 🌐 Python | 📅 2026-09-16 - CAN tools in python for DBC, KCD, SYM, ARXML 4 and CDD file parsing.
...
* [PiCCANTE](https://github.com/Alia5/PiCCANTE) ⭐ 94 | 🐛 12 | 🌐 C++ | 📅 2026-01-26 - Open-source CAN hacking tool based on Raspberry Pi Pico (1|2|W) - Up to 3x CAN interfaces, includes ELM327 emulator.
...
* 🔝[panda](https://github.com/commaai/panda) ⭐ 1,701 | 🐛 59 | 🌐 C | 📅 2026-09-13 - It supports 3x CAN, 2x LIN, and 1x GMLAN (and it has J2534 over USB on host side). It uses an STM32F413 (Using a panda with cabana provides the best RE and development suites for CANBUS).
...
* [candleLight\_fw](https://github.com/candle-usb/candleLight_fw) ⭐ 952 | 🐛 32 | 🌐 C | 📅 2026-09-17 - Compatible firmware for candleLight, cantact, canable, CANAlyze, VulCAN.
...
* [RejsaCAN-ESP32](https://github.com/MagnusThome/RejsaCAN-ESP32) ⭐ 801 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - ESP32-S3 board with CAN interface.
* [RejsaCAN-ESP32-C6](https://github.com/MagnusThome/RejsaCAN-ESP32/tree/main/Code%20Examples/RejsaCAN%20v6.x%20-%20ESP32-C6%20-%20DUAL%20CAN%20self%20test) ⭐ 801 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - Example code that is tested and runs on the new ESP32-C6 that has TWO built in CAN controllers.
...
* [CTU-CAN-FD](https://github.com/Logic-Design-Services/CTU-CAN-FD) ⭐ 73 | 🐛 14 | 🌐 VHDL | 📅 2026-08-17 - CAN FD IP Core, ISO 11898-1:2015 compliant (VHDL).
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07 root-repo for lastest updates.
2. The another awesome list :arrow\_forward: [CAN ID collections](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 985 | 🐛 0 | 📅 2026-08-12 :arrow\_backward: also might be useful.

...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
...
* 🔝[Caring Caribou](https://github.com/CaringCaribou/caringcaribou) ⭐ 945 | 🐛 14 | 🌐 Python | 📅 2026-06-12 - A friendly car security exploration tool for the CAN bus.
...
* [parse\_can\_logs](https://github.com/v-ivanyshyn/parse_can_logs) ⭐ 98 | 🐛 3 | 🌐 Python | 📅 2024-06-28 - Parse CAN logs and visualize data streams on plot.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,520 | 🐛 139 | 🌐 Python | 📅 2026-09-04 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
* [canDrive](https://github.com/adamtheone/canDrive) ⭐ 680 | 🐛 25 | 🌐 C | 📅 2023-05-27 - Tools for hacking your car.
...
* [UDSim](https://github.com/zombieCraig/UDSim) ⭐ 335 | 🐛 4 | 🌐 C++ | 📅 2022-12-10 - Unified Diagnostic Services Simulator and Fuzzer (successor of uds-server).
* [Carpunk](https://github.com/souravbaghz/Carpunk) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2025-04-20 - CAN injection toolkit and successor of CANghost.
* 🔝[can-explorer](https://github.com/Tbruno25/can-explorer) ⭐ 303 | 🐛 1 | 🌐 Python | 📅 2026-04-23 - A CAN bus visualization tool to aid in reverse engineering.
...
* [ELM327-emulator](https://github.com/Ircama/ELM327-emulator) ⭐ 673 | 🐛 17 | 🌐 Python | 📅 2026-02-22 - ELM327 Emulator for testing software interfacing OBDII via ELM327 adapter supporting multi-ECU simulation.
...
* [DDT4All](https://github.com/cedricp/ddt4all) ⭐ 1,830 | 🐛 0 | 🌐 Python | 📅 2026-08-23 - Tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
...
* [OBDium](https://github.com/provrb/obdium) ⭐ 361 | 🐛 5 | 🌐 Rust | 📅 2026-08-29 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [ELM327SLCAN](https://github.com/qnx425/ELM327SLCAN) ⭐ 74 | 🐛 1 | 🌐 C | 📅 2019-01-26 - ELM327 based vehicle's CAN bus sniffer.
...
* [uds-c](https://github.com/openxc/uds-c) ⭐ 825 | 🐛 6 | 🌐 C | 📅 2021-08-16 - Unified Diagnostics Service (UDS) and OBD-II C Library.
* [python-UDSonCAN](https://github.com/pylessard/python-udsoncan) ⭐ 726 | 🐛 9 | 🌐 Python | 📅 2026-08-09 - Python implementation of UDS ISO-14229 standard.
* [iso14229](https://github.com/driftregion/iso14229) ⭐ 359 | 🐛 4 | 🌐 C | 📅 2026-09-02 - C implementation of UDS ISO-14229 server and client for embedded systems.

### ISO-TP

*ISO 15765-2 Standard*

* [isotp-c](https://github.com/openxc/isotp-c) ⭐ 360 | 🐛 8 | 🌐 C | 📅 2021-08-16 - An implementation of the ISO-TP (ISO15765-2) CAN protocol in C.
* [python-can-IsoTP](https://github.com/pylessard/python-can-isotp) ⭐ 314 | 🐛 2 | 🌐 Python | 📅 2026-08-22 - Python implementation of the ISO-TP (ISO15765-2) CAN protocol.
...
* [Open-SAE-J1939](https://github.com/DanielMartensson/Open-SAE-J1939) ⭐ 646 | 🐛 1 | 🌐 C | 📅 2026-06-25 - SAE J1939 protocol free to use for embedded systems or PC with CAN-bus.
...
* [TruckDevil](https://github.com/LittleBlondeDevil/TruckDevil) ⭐ 62 | 🐛 5 | 🌐 Python | 📅 2026-09-03 - A tool and framework for interacting with and assessing ECUs that use J1939 for communications on the CANBUS.
...
* [BUSMASTER](https://github.com/rbei-etas/busmaster) ⭐ 1,076 | 🐛 670 | 🌐 C++ | 📅 2023-07-11 - An Open Source Software tool to simulate, analyze and test data bus systems such as CAN.
* [CANiBUS](https://github.com/Hive13/CANiBUS/) ⚠️ Archived - CAN Device Vehicle Research Server (OpenGarages.org).
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) ⭐ 77 | 🐛 5 | 🌐 C | 📅 2026-08-25 - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,911 | 🐛 62 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,911 | 🐛 62 | 🌐 C | 📅 2026-05-12.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,150 | 🐛 162 | 🌐 C++ | 📅 2026-08-10 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,815 | 🐛 285 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [ICSim](https://github.com/zombieCraig/ICSim) ⭐ 977 | 🐛 21 | 🌐 C | 📅 2025-09-18 - Instrument Cluster Simulator for SocketCAN by OpenGarages.
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 860 | 🐛 57 | 🌐 C++ | 📅 2026-09-03 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
* [TSMaster](https://github.com/TOSUN-Shanghai/TSMaster) ⭐ 427 | 🐛 85 | 📅 2026-07-07 - Powerful open environment for automotive bus monitoring, simulation, testing, diagnostics, calibration and so on *(Closed source)*.
* [CANgaroo](https://github.com/HubertD/cangaroo) ⭐ 421 | 🐛 22 | 🌐 C++ | 📅 2023-10-27 - Qt-based CAN bus analyzer software.
* [Kayak](https://github.com/dschanoeh/Kayak) ⚠️ Archived - Java-based CAN traffic GUI analysis tool *(archived)*.
* [CANviz](https://github.com/Chanchaldhiman/CANviz) ⭐ 283 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-08 - Browser-based CAN bus analyzer with J1939 and CANopen CiA 301/402 passive decode. Installs via pip, no native app required. Works with almost any CAN harware including low cost ones.
...
* [Plotter and Scanner from SmartGauges](https://github.com/smartgauges/obd2-bt-stm32/tree/master/qt) ⭐ 43 | 🐛 4 | 🌐 C | 📅 2024-04-28 - Scanning and visualizing tool for automotive systems.
...
* [canair](https://github.com/philipkocanda/canair) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2026-08-25 - CLI/TUI for reverse engineering CAN/UDS diagnostics over-the-air using a WiCAN or a generic ELM327 dongle.
...
* 🔝[cantools](https://github.com/cantools/cantools) ⭐ 2,281 | 🐛 129 | 🌐 Python | 📅 2026-09-04 - CAN BUS tools in Python.

<!--lint disable double-link-->

* 🔝[python-can](https://github.com/hardbyte/python-can) ⭐ 1,588 | 🐛 275 | 🌐 Python | 📅 2026-07-01 - CAN package provides controller area network support for Python developers.

<!--lint enable double-link-->

* [strym](https://github.com/jmscslgroup/strym) ⭐ 39 | 🐛 8 | 🌐 Python | 📅 2026-07-07 - Real time CAN data logging and visualization tool to work with USB-CAN Interface.
...
* [iso15765-canbus](https://github.com/devcoons/iso15765-canbus) ⭐ 197 | 🐛 0 | 🌐 C | 📅 2026-06-22 -  Implementation of ISO15765-2 in C.
* [JavaCAN](https://github.com/pschichtel/JavaCAN) ⭐ 68 | 🐛 6 | 🌐 Java | 📅 2026-09-04 - A Java binding library for SocketCAN with support for RAW, BCM and ISO-TP sockets using epoll-based event-driven IO.
* [CanKit](https://github.com/pkuyo/CanKit) ⭐ 42 | 🐛 13 | 🌐 C# | 📅 2026-09-04 - Cross-platform C#/.NET CAN communication library with a unified API across multiple CAN adapters.
...
* [CANvenient](https://github.com/CANopenTerm/CANvenient) ⭐ 11 | 🐛 1 | 🌐 C | 📅 2026-07-03 - An abstraction layer for multiple CAN APIs on Windows and Linux.
...
* 🔝[cantools by Erik Moqvist](https://github.com/eerimoq/cantools) ⭐ 2,281 | 🐛 129 | 🌐 Python | 📅 2026-09-04 - CAN tools in python for DBC, KCD, SYM, ARXML 4 and CDD file parsing.
...
* [dbcc](https://github.com/howerj/dbcc) ⭐ 457 | 🐛 1 | 🌐 C | 📅 2025-10-07 - DBC to C (and CSV, JSON and XML) compiler using the mpc parser combinator library.
...
* [PiCCANTE](https://github.com/Alia5/PiCCANTE) ⭐ 92 | 🐛 12 | 🌐 C++ | 📅 2026-01-26 - Open-source CAN hacking tool based on Raspberry Pi Pico (1|2|W) - Up to 3x CAN interfaces, includes ELM327 emulator.
...
* 🔝[panda](https://github.com/commaai/panda) ⭐ 1,701 | 🐛 65 | 🌐 C | 📅 2026-08-26 - It supports 3x CAN, 2x LIN, and 1x GMLAN (and it has J2534 over USB on host side). It uses an STM32F413 (Using a panda with cabana provides the best RE and development suites for CANBUS).
* 🔝[pcan\_pro\_x](https://github.com/moonglow/pcan_pro_x) ⭐ 349 | 🐛 13 | 🌐 C | 📅 2022-03-11 - PEAK PCAN PRO/PRO FD firmware for STM32F4 based boards.
...
* [candleLight\_fw](https://github.com/candle-usb/candleLight_fw) ⭐ 947 | 🐛 33 | 🌐 C | 📅 2026-07-17 - Compatible firmware for candleLight, cantact, canable, CANAlyze, VulCAN.
* [pcan\_cantact](https://github.com/moonglow/pcan_cantact) ⭐ 437 | 🐛 3 | 🌐 C | 📅 2022-07-28 - XCAN firmware for CANtact ( CANable ) or any other similar boards based on STM32F042.
...
* [candleLight](https://github.com/HubertD/candleLight) ⭐ 397 | 🐛 1 | 🌐 KiCad | 📅 2022-07-28 - KiCAD project of usb-can adapter based on STM32F0.
* [CANAlyze](https://kkuchera.github.io/canalyze/) - An open source, native CAN interface for Linux that can be built entirely using open source tools, use [canalyze-fw](https://github.com/kkuchera/canalyze-fw) ⭐ 74 | 🐛 9 | 🌐 C | 📅 2023-11-14 as firmware source.
...
* [W203-canbus](https://github.com/rnd-ash/W203-canbus) ⭐ 170 | 🐛 3 | 🌐 C++ | 📅 2020-08-07 - Arduino project for W211/W219 W203/W209 Mercedes (bluetooth audio control and more).
...
* [arduino-mcp2515](https://github.com/autowp/arduino-mcp2515) ⭐ 1,026 | 🐛 65 | 🌐 C++ | 📅 2026-02-27 - Arduino MCP2515 CAN interface library.
* [arduino-OBD2](https://github.com/sandeepmistry/arduino-OBD2) ⭐ 571 | 🐛 15 | 🌐 C++ | 📅 2022-12-29 - Arduino library for reading OBD-II data from your car over CAN bus.
...
* [RejsaCAN-ESP32](https://github.com/MagnusThome/RejsaCAN-ESP32) ⭐ 791 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - ESP32-S3 board with CAN interface.
* [RejsaCAN-ESP32-C6](https://github.com/MagnusThome/RejsaCAN-ESP32/tree/main/Code%20Examples/RejsaCAN%20v6.x%20-%20ESP32-C6%20-%20DUAL%20CAN%20self%20test) ⭐ 791 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - Example code that is tested and runs on the new ESP32-C6 that has TWO built in CAN controllers.
...
* [ESP32RET](https://github.com/collin80/ESP32RET) ⭐ 406 | 🐛 46 | 🌐 C++ | 📅 2026-01-15 - CAN Reverse engineering tool for ESP32 based boards (unmaintained).
* [ESP32-Arduino-CAN](https://github.com/miwagner/ESP32-Arduino-CAN) ⭐ 390 | 🐛 33 | 🌐 C | 📅 2024-07-29 - Arduino CAN-Bus library for ESP32.
* [esp32\_obd2](https://github.com/MagnusThome/esp32_obd2) ⭐ 73 | 🐛 0 | 🌐 C++ | 📅 2023-12-23 - Simplified OBD2 layer to run on top of the esp32\_can library that supports the newer ESP32-S3 (Arduino library).
...
* [CAN-wizard](https://github.com/okhsunrog/can_wizard) ⭐ 39 | 🐛 1 | 🌐 C | 📅 2026-08-26 - CAN bus sniffer on esp32/esp32-c3 + SN65HVD230. Is developed using ESP-IDF and implement serial control console.
...
* [CTU-CAN-FD](https://github.com/Logic-Design-Services/CTU-CAN-FD) ⭐ 72 | 🐛 13 | 🌐 VHDL | 📅 2026-08-17 - CAN FD IP Core, ISO 11898-1:2015 compliant (VHDL).
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07 root-repo for lastest updates.
2. The another awesome list :arrow\_forward: [CAN ID collections](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 979 | 🐛 0 | 📅 2026-08-12 :arrow\_backward: also might be useful.

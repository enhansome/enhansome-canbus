...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,474 | 🐛 7 | 📅 2026-08-07
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,559 | 🐛 142 | 🌐 Python | 📅 2026-09-20 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
...
* [DDT4All](https://github.com/cedricp/ddt4all) ⭐ 1,857 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
...
* [OBDium](https://github.com/provrb/obdium) ⭐ 388 | 🐛 4 | 🌐 Rust | 📅 2026-09-10 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) ⭐ 77 | 🐛 5 | 🌐 C | 📅 2026-09-21 - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,918 | 🐛 61 | 🌐 C | 📅 2026-09-20 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,918 | 🐛 61 | 🌐 C | 📅 2026-09-20.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,193 | 🐛 100 | 🌐 C++ | 📅 2026-09-21 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,844 | 🐛 285 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 871 | 🐛 59 | 🌐 C++ | 📅 2026-09-18 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
...
* 🔝[panda](https://github.com/commaai/panda) ⭐ 1,701 | 🐛 61 | 🌐 C | 📅 2026-09-21 - It supports 3x CAN, 2x LIN, and 1x GMLAN (and it has J2534 over USB on host side). It uses an STM32F413 (Using a panda with cabana provides the best RE and development suites for CANBUS).
...
* [RejsaCAN-ESP32](https://github.com/MagnusThome/RejsaCAN-ESP32) ⭐ 802 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - ESP32-S3 board with CAN interface.
* [RejsaCAN-ESP32-C6](https://github.com/MagnusThome/RejsaCAN-ESP32/tree/main/Code%20Examples/RejsaCAN%20v6.x%20-%20ESP32-C6%20-%20DUAL%20CAN%20self%20test) ⭐ 802 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - Example code that is tested and runs on the new ESP32-C6 that has TWO built in CAN controllers.
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,474 | 🐛 7 | 📅 2026-08-07 root-repo for lastest updates.
2. The another awesome list :arrow\_forward: [CAN ID collections](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 986 | 🐛 0 | 📅 2026-08-12 :arrow\_backward: also might be useful.

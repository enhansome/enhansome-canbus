...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,514 | 🐛 148 | 🌐 Python | 📅 2026-09-03 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
* [canDrive](https://github.com/adamtheone/canDrive) ⭐ 681 | 🐛 25 | 🌐 C | 📅 2023-05-27 - Tools for hacking your car.
...
* [OBDium](https://github.com/provrb/obdium) ⭐ 357 | 🐛 5 | 🌐 Rust | 📅 2026-08-29 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [iso14229](https://github.com/driftregion/iso14229) ⭐ 360 | 🐛 4 | 🌐 C | 📅 2026-09-02 - C implementation of UDS ISO-14229 server and client for embedded systems.
...
* [Open-SAE-J1939](https://github.com/DanielMartensson/Open-SAE-J1939) ⭐ 644 | 🐛 0 | 🌐 C | 📅 2026-06-25 - SAE J1939 protocol free to use for embedded systems or PC with CAN-bus.
...
* [BUSMASTER](https://github.com/rbei-etas/busmaster) ⭐ 1,075 | 🐛 670 | 🌐 C++ | 📅 2023-07-11 - An Open Source Software tool to simulate, analyze and test data bus systems such as CAN.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,143 | 🐛 162 | 🌐 C++ | 📅 2026-08-10 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,809 | 🐛 285 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 860 | 🐛 56 | 🌐 C++ | 📅 2026-09-03 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
...
* [CanKit](https://github.com/pkuyo/CanKit) ⭐ 42 | 🐛 10 | 🌐 C# | 📅 2026-09-03 - Cross-platform C#/.NET CAN communication library with a unified API across multiple CAN adapters.
...
* 🔝[panda](https://github.com/commaai/panda) ⭐ 1,700 | 🐛 65 | 🌐 C | 📅 2026-08-26 - It supports 3x CAN, 2x LIN, and 1x GMLAN (and it has J2534 over USB on host side). It uses an STM32F413 (Using a panda with cabana provides the best RE and development suites for CANBUS).
...
* [candleLight\_fw](https://github.com/candle-usb/candleLight_fw) ⭐ 946 | 🐛 33 | 🌐 C | 📅 2026-07-17 - Compatible firmware for candleLight, cantact, canable, CANAlyze, VulCAN.
...
* [RejsaCAN-ESP32](https://github.com/MagnusThome/RejsaCAN-ESP32) ⭐ 787 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - ESP32-S3 board with CAN interface.
* [RejsaCAN-ESP32-C6](https://github.com/MagnusThome/RejsaCAN-ESP32/tree/main/Code%20Examples/RejsaCAN%20v6.x%20-%20ESP32-C6%20-%20DUAL%20CAN%20self%20test) ⭐ 787 | 🐛 1 | 🌐 C++ | 📅 2026-07-26 - Example code that is tested and runs on the new ESP32-C6 that has TWO built in CAN controllers.

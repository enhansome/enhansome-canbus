...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,466 | 🐛 6 | 📅 2026-08-07
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,545 | 🐛 139 | 🌐 Python | 📅 2026-09-12 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
...
* [OBDium](https://github.com/provrb/obdium) ⭐ 377 | 🐛 4 | 🌐 Rust | 📅 2026-09-10 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [Open-SAE-J1939](https://github.com/DanielMartensson/Open-SAE-J1939) ⭐ 650 | 🐛 2 | 🌐 C | 📅 2026-09-11 - SAE J1939 protocol free to use for embedded systems or PC with CAN-bus.
...
* [BUSMASTER](https://github.com/rbei-etas/busmaster) ⭐ 1,077 | 🐛 670 | 🌐 C++ | 📅 2023-07-11 - An Open Source Software tool to simulate, analyze and test data bus systems such as CAN.
* [CANiBUS](https://github.com/Hive13/CANiBUS/) ⚠️ Archived - CAN Device Vehicle Research Server (OpenGarages.org).
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) ⭐ 77 | 🐛 5 | 🌐 C | 📅 2026-09-14 - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,913 | 🐛 61 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,913 | 🐛 61 | 🌐 C | 📅 2026-05-12.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,181 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,835 | 🐛 286 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 871 | 🐛 57 | 🌐 C++ | 📅 2026-09-14 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
...
* [CANviz](https://github.com/Chanchaldhiman/CANviz) ⭐ 285 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-08 - Browser-based CAN bus analyzer with J1939 and CANopen CiA 301/402 passive decode. Installs via pip, no native app required. Works with almost any CAN harware including low cost ones.
...
* 🔝[cantools](https://github.com/cantools/cantools) ⭐ 2,285 | 🐛 128 | 🌐 Python | 📅 2026-09-15 - CAN BUS tools in Python.
...
* [JavaCAN](https://github.com/pschichtel/JavaCAN) ⭐ 68 | 🐛 7 | 🌐 Java | 📅 2026-09-15 - A Java binding library for SocketCAN with support for RAW, BCM and ISO-TP sockets using epoll-based event-driven IO.
...
* 🔝[cantools by Erik Moqvist](https://github.com/eerimoq/cantools) ⭐ 2,285 | 🐛 128 | 🌐 Python | 📅 2026-09-15 - CAN tools in python for DBC, KCD, SYM, ARXML 4 and CDD file parsing.
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07 root-repo for lastest updates.
2. The another awesome list :arrow\_forward: [CAN ID collections](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 983 | 🐛 0 | 📅 2026-08-12 :arrow\_backward: also might be useful.

...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/stargazers/) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/network/) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-canbus/)](https://GitHub.com/iDoka/awesome-canbus/watchers/) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
[![GitHub contributors](https://badgen.net/github/contributors/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/graphs/contributors/) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
[![GitHub pull-requests merged](https://badgen.net/github/merged-prs/iDoka/awesome-canbus)](https://github.com/iDoka/awesome-canbus/pulls?q=is%3Amerged) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
[![GitHub latest commit](https://badgen.net/github/last-commit/iDoka/awesome-canbus)](https://GitHub.com/iDoka/awesome-canbus/commit/) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
...
Permanent URL to this list: <https://github.com/iDoka/awesome-canbus> ⭐ 3,422 | 🐛 6 | 📅 2026-08-07
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,481 | 🐛 134 | 🌐 Python | 📅 2026-08-18 - Python-based interactive packet manipulation program & library. Supports CAN/ISOTP/UDS/GMLAN plus many other protocols.
...
* [DDT4All](https://github.com/cedricp/ddt4all) ⭐ 1,811 | 🐛 1 | 🌐 Python | 📅 2026-07-14 - Tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
...
* [OBDium](https://github.com/provrb/obdium) ⭐ 333 | 🐛 5 | 🌐 Rust | 📅 2026-07-21 - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [python-UDSonCAN](https://github.com/pylessard/python-udsoncan) ⭐ 724 | 🐛 9 | 🌐 Python | 📅 2026-08-09 - Python implementation of UDS ISO-14229 standard.
* [iso14229](https://github.com/driftregion/iso14229) ⭐ 355 | 🐛 7 | 🌐 C | 📅 2026-08-18 - C implementation of UDS ISO-14229 server and client for embedded systems.
...
* [python-can-IsoTP](https://github.com/pylessard/python-can-isotp) ⭐ 313 | 🐛 4 | 🌐 Python | 📅 2026-06-26 - Python implementation of the ISO-TP (ISO15765-2) CAN protocol.
...
* 🔝[Linux CAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,906 | 🐛 62 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space useful utils.
* [J1939](https://docs.kernel.org/networking/j1939.html) - Linux kernel support (kernel >= 5.4) also see [can-j1939 kernel module](https://github.com/linux-can/can-utils/blob/master/can-j1939-install-kernel-module.md) ⭐ 2,906 | 🐛 62 | 🌐 C | 📅 2026-05-12.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,122 | 🐛 159 | 🌐 C++ | 📅 2026-08-10 - The Powerful Time Series Visualization Tool (With panda hardware, cabana and plotjuggler, you can quickly RE the entire car in a few days).
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,773 | 🐛 283 | 🌐 C++ | 📅 2026-05-15 - Cross-platform Qt based GUI analysis tool. Supports SocketCAN compatible interfaces.
...
* [EcuBus-Pro](https://github.com/ecubus/EcuBus-Pro) ⭐ 844 | 🐛 55 | 🌐 C++ | 📅 2026-08-18 - A powerful automotive ECU development tool. UDS, CAN-TP, DOIP, LIN , Script(TS) like CAPL.
...
* 🔝[cantools](https://github.com/cantools/cantools) ⭐ 2,270 | 🐛 128 | 🌐 Python | 📅 2026-08-17 - CAN BUS tools in Python.

<!--lint disable double-link-->

* 🔝[python-can](https://github.com/hardbyte/python-can) ⭐ 1,585 | 🐛 270 | 🌐 Python | 📅 2026-07-01 - CAN package provides controller area network support for Python developers.
...
* 🔝[cantools by Erik Moqvist](https://github.com/eerimoq/cantools) ⭐ 2,270 | 🐛 128 | 🌐 Python | 📅 2026-08-17 - CAN tools in python for DBC, KCD, SYM, ARXML 4 and CDD file parsing.
...
* 🔝[panda](https://github.com/commaai/panda) ⭐ 1,694 | 🐛 65 | 🌐 C | 📅 2026-08-19 - It supports 3x CAN, 2x LIN, and 1x GMLAN (and it has J2534 over USB on host side). It uses an STM32F413 (Using a panda with cabana provides the best RE and development suites for CANBUS).
...
1. Please follow [this](https://github.com/iDoka/awesome-canbus) ⭐ 3,422 | 🐛 6 | 📅 2026-08-07 root-repo for lastest updates.
